...
exports.calculateFORGEMetrics = calculateFORGEMetrics;
...
function calculateFORGEMetrics(records) {
    ...
    return Object.assign(Object.assign({}, avg), { timestamp: new Date(), recordsAnalyzed: count });
}
