...
function calculateConsistencyScore(records: AuditRecord[]): number {
...
function calculateReproducibilityScore(records: AuditRecord[]): number {
...
function calculateIntegrityScore(records: AuditRecord[]): number {
  if (records.length <= 1) return 1;
...
function calculateExplainabilityScore(records: AuditRecord[]): number {
  if (records.length === 0) return 1;
...
function calculateSecurityScore(records: AuditRecord[]): number {
  if (records.length === 0) return 1;
