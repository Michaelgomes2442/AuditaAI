...
// CORE FUNCTIONS
// ============================================================================
export function applySpeechcraft(input) {
...
function applyPersonaFrame(persona, text, governance) {
...
function applyGovernanceInstructions(text, governance, persona) {
 ...
 */
function assertPlaceholdersPresent(template, placeholders) {
 ...
 */
function assertAnchorPresent(text, anchor) {
 ...
 */
function extractRegionsOutsideCDATA(text) {
    const regions = [];
    let currentPos = 0;
 ...
 */
function computeTemplateHash(templateContent) {
 ...
 */
function computeLocalExecHash(content) {
    let hash = 0;
